...
include "/xampp/htdocs/gvinf/connect.php";
 ...
 if(empty($fname) ||  empty($email) ||
  ...
  $stmt = $con->prepare("insert into incognito(fname,email,mobile,college) values(?,?,?,?)");
...
$mail->Body    = '<div style="border:2px solid red;"> <b> You Have Successfully Registered for Incognito. </b>
                   <img src="cid:solly">';
