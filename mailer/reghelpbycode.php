...
include "/xampp/htdocs/gvinf/connect.php";
 ...
 if(empty($fname) ||  empty($email) ||
  ...
  $stmt = $con->prepare("insert into helpbycode(fname,email,mobile,college) values(?,?,?,?)");
...
$mail->Body    = '<div style="border:2px solid red;"> <b> You Have Successfully Registered for Help By Code. </b>
                   <img src="cid:solly">';
