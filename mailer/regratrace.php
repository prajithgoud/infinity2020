...
include "/xampp/htdocs/gvinf/connect.php";
 ...
 if(empty($fname) ||  empty($email) ||
  ...
  $stmt = $con->prepare("insert into ratrace(fname,email,mobile,college) values(?,?,?,?)");
...
$mail->Body    = '<div style="border:2px solid red;"> <b> You Have Successfully Registered for Rat Race. </b>
                   <img src="cid:solly">';
