...
include "/xampp/htdocs/gvinf/connect.php";
 ...
 if(empty($fname) ||  empty($email) ||
  ...
  $stmt = $con->prepare("insert into startwith(fname,email,mobile,college) values(?,?,?,?)");
...
$mail->Body    = '<div style="border:2px solid red;"> <b> You Have Successfully Registered for Start With Rs.50  </b>
                   <img src="cid:solly">';
